        ...
        fillHtml: function(obj, args) {
            return (function() {
                ...
                if (parseInt(parseInt(args.current)) > 1) {
                    obj.append('<a href="javascript:;" class="prevPage"><img src="images/icon-more-02.png"></a>');
                } else {
                    obj.remove('.prevPage');
                    obj.append('<span class="disabled"><img src="images/icon-more-02.png"></span>');
                }
                //中间页码
                ...
                if (parseInt(parseInt(args.current)) < parseInt(parseInt(args.pageCount))) {
                    obj.append('<a href="javascript:;" class="nextPage"><img src="images/icon-more-02.png"><img src="images/icon-more-002.png"></a>');
                } else {
                    obj.remove('.nextPage');
                    obj.append('<span class="disabled"><img src="images/icon-more-02.png"><img src="images/icon-more-002.png"></span>');
                }
