$(function(){
    ...
    var t1 = setTimeout(function(){
        $(".box1-content .text2,.box1-content .text4,.box1-content .text7").css("opacity","1")
        clearTimeout(t1)
    },600)
    var t2 = setTimeout(function(){
        $(".box1-content .text1,.box1-content .text5,.box1-content .text6,.box1-content .text9").css("opacity","1")
        clearTimeout(t2)
    },800)
